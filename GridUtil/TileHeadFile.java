...
public class TileHeadFile {
   ...
   private  short TILE_SIZE;//瓦片尺寸
	...
	public static void main(String[] args) {
		...
		try {
			mydis = new myDataInputStream(new FileInputStream("E:\\RAS数据\\Africa256\\headMsg"));
			short TILE_SIZE = mydis.readShort();
			int ROW = mydis.readInt();
			int COL = mydis.readInt();
			...
			int ROW_NUM = mydis.readInt();
			int COL_NUM = mydis.readInt();
